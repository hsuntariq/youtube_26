...
<body class="bg-zinc-950 text-zinc-100 min-h-screen">
    ...
    <div class="max-w-screen-xl mx-auto px-4 py-5 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="relative bg-black rounded-xl overflow-hidden aspect-video group mb-3">
                ...
                <!-- Video Element -->
                <video id="videoEl" class="absolute inset-0 w-full h-full object-cover" src="your-video.mp4"
                    preload="metadata" onclick="togglePlay()"></video>
    ...
    <script>
        ...
        Here's the updated video player section using a real HTML <video> tag with full custom controls:
        html < div class="relative bg-black rounded-xl overflow-hidden aspect-video group mb-3" >
  ...
  <!--Controls Bar-- >
            ...
            >
                <!-- Progress Bar -->
                <div
                    class="relative w-full h-1 bg-white/30 rounded-full cursor-pointer mb-2"
                    id="progressBar"
                    onclick="seek(event, this)"
                >
                    <div id="progressFill" class="h-full bg-red-500 rounded-full relative" style="width:0%">
                ...
                <div class="flex items-center justify-between text-white text-xs">
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Playback Speed -->
                        <button onclick="cycleSpeed(this)" class="hover:text-zinc-300 transition-colors text-xs">1x</button>
