    ...
    <div class="max-w-screen-xl mx-auto px-4 py-5 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="relative bg-black rounded-xl overflow-hidden aspect-video group mb-3">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-slate-900 via-zinc-900 to-zinc-800 flex items-center justify-center">
                    <div
                        class="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_30%_50%,_#3b82f6,_transparent_60%)]">
                    </div>
                    <button id="playBtn" onclick="togglePlay()"
                        class="relative z-10 w-16 h-16 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur border border-white/20 flex items-center justify-center transition-all duration-200 hover:scale-105">
                ...
                <div
                    ...
                    <div class="relative w-full h-1 bg-white/30 rounded-full cursor-pointer mb-2"
            ...
            <!-- Title -->
            <h1 class="text-lg font-semibold leading-snug mb-2">Building a Full-Stack App with Next.js 14, Prisma &
                Tailwind CSS — Complete Tutorial (2024)</h1>
            ...
            <div id="descBox" class="mt-3 bg-zinc-900 rounded-xl p-4 text-sm text-zinc-300 leading-relaxed">
                <p id="descShort">In this comprehensive tutorial, we build a full-stack application from scratch using
                    the latest Next.js 14 App Router, Prisma ORM with PostgreSQL, and Tailwind CSS. Perfect for
                    developers ready to level up their skills...</p>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <div>
                                        <p class="text-xs"><span class="font-semibold text-blue-400">@CodeWithDev</span>
                                            <span class="text-zinc-500 ml-1">1 day ago</span></p>
