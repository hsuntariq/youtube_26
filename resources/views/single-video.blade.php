            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative bg-black rounded-xl overflow-hidden aspect-video group mb-3">
                    ...
                    <video id="videoEl" class="absolute inset-0 w-full h-full object-cover"
                        src="{{ asset('/storage/' . $video['video']) }}" preload="metadata"
                        ...
                        <div class="flex items-center justify-between text-white text-xs">
                            <div class="flex items-center gap-3">
                                ...
                                <input id="volumeSlider" type="range" min="0" max="1" step="0.05"
                                    ...
                                    class="w-16 accent-red-500 cursor-pointer" />
                            </div>
                ...
                <div id="descBox" class="mt-3 bg-zinc-900 rounded-xl p-4 text-sm text-zinc-300 leading-relaxed">
                    ...
                    <div id="descFull" class="hidden mt-2 space-y-2">
                        ...
                        <p class="text-zinc-400 text-xs mt-2">Source code:
                            github.com/codewithdev/nextjs-tutorial<br />00:00
                            Intro &nbsp; 02:15 Project Setup &nbsp; 06:30 Database &nbsp; 14:00 Auth &nbsp; 20:00 Deploy
                        </p>
                    </div>
                    ...
                    <div class="flex gap-3 mb-6">
                        ...
                        <form class="flex-1">
                            ...
                            <div id="commentBtns" class="hidden justify-end gap-2 mt-2 flex">
                                ...
                                <button
                                    class="px-4 py-1.5 comment-btn text-sm rounded-full bg-blue-600 hover:bg-blue-500 text-white font-medium transition-colors">
                    ...
                    <div class="flex gap-3 group cursor-pointer" onclick="">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-blue-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">18:42</span>
                        </div>
                    ...
                    <div class="flex gap-3 group cursor-pointer">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-emerald-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">24:10</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-sm font-medium leading-snug line-clamp-2 group-hover:text-blue-400 transition-colors">
                    ...
                    <div class="flex gap-3 group cursor-pointer">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-violet-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">31:05</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-sm font-medium leading-snug line-clamp-2 group-hover:text-blue-400 transition-colors">
                    ...
                    <div class="flex gap-3 group cursor-pointer">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-amber-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">14:27</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-sm font-medium leading-snug line-clamp-2 group-hover:text-blue-400 transition-colors">
                    ...
                    <div class="flex gap-3 group cursor-pointer">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-rose-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">09:55</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-sm font-medium leading-snug line-clamp-2 group-hover:text-blue-400 transition-colors">
                    ...
                    <div class="flex gap-3 group cursor-pointer">
                        <div class="w-40 flex-shrink-0 rounded-lg overflow-hidden aspect-video relative bg-zinc-800">
                            <div
                                ...
                                <svg class="w-8 h-8 text-cyan-300 opacity-60" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z" />
                                </svg>
                            </div>
                            <span
                                class="absolute bottom-1 right-1 text-xs bg-black/80 text-white px-1 rounded">42:18</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p
                                class="text-sm font-medium leading-snug line-clamp-2 group-hover:text-blue-400 transition-colors">
